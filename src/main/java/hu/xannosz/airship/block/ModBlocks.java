...
public class ModBlocks {
	...
	public static final RegistryObject<Block> LOCAL_RUNE = registerBlock("local_rune", LocalRune::new);
	public static final RegistryObject<Block> RADAR = registerBlock("radar", Radar::new);
