...
public class LocalRuneData {
	...
	public LocalRuneData(BlockPos position) {
		this.position = position;
	}

	public LocalRuneData(FriendlyByteBuf buf) {
	...
	public void handler(Supplier<NetworkEvent.Context> supplier) {
		...
		context.enqueueWork(() ->
				...
				DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () ->
						ClientPacketHandler.handleLocalRuneData(this, supplier))
		);
	}
}
