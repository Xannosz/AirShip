...
public class NavigationTableScreen extends AbstractContainerScreen<NavigationTableMenu> {
	...
	private int correctHue(int color) {
	...
	private void renderExtendedTexts(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		if (y + 32 < mouseY && mouseY < y + 41 && x + 113 < mouseX && mouseX < x + 160) {
			guiGraphics.renderTooltip(this.font,
					Component.literal(getMenu().getMapData().getDirection().getName()), x + 110, y + 60);
		}
	}
}
